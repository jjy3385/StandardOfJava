...
public class ObjectsTest {
    public static void main(String[] args) {
        ...
        System.out.print("strD2 = {");
        for(String[] tmp : str2D)
            System.out.print(Arrays.toString(tmp));
        System.out.println("}");

        System.out.print("std2D_2={");
        ...
        System.out.println("toString(null, \"\") =" +Objects.toString(null,""));    //두번째 매개변수는 첫번째 매개변수가 null일 때 대신 사용할 값
        ...
        System.out.println("compare(\"ab\",\"AB\")=" +compare("aa","AB",c));
